...
import com.followal.base.utils.LinearGradient;
...
public class WheelPicker<T> extends View {
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mSelectedItemTextColor = a.getColor(R.styleable.WheelPicker_selectedTextColor, getResources().getColor(R.color.colorPrimary));
        ...
        mCurtainBorderColor = a.getColor(R.styleable.WheelPicker_wheelCurtainBorderColor, getResources().getColor(R.color.com_ycuwq_datepicker_divider));
