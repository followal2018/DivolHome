package com.followal.base.permissions;
...
import com.followal.base.utils.ScreenUtils;
    ...
    public static AlertDialog.Builder createFor(@NonNull Context context, @NonNull String message, @DrawableRes int... drawables) {
        ...
        for (int i = 0; i < drawables.length; i++) {
            ...
            if (i != drawables.length - 1) {
                ...
                layoutParams.setMargins(ScreenUtils.Companion.dpToPx(context, 20), 0, ScreenUtils.Companion.dpToPx(context, 20), 0);
