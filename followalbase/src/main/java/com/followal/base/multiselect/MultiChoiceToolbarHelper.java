package com.followal.base.multiselect;
...
class MultiChoiceToolbarHelper {
    ...
    private void showMultiChoiceToolbar() {
        mSupportActionBar.setHomeAsUpIndicator(R.drawable.ic_back_icon);
    ...
    private void updateToolbarTitle(int itemNumber) {
        if (itemNumber > 0) {
            ...
            if (selectedToolbarQuantityTitle != 0 && selectedToolbarQuantityTitle != -1) {
